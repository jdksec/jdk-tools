write-output "[*] Windows Domain and Host Audit Script`n" | tee-object -append audit.txt
write-output "`n[*] SystemInfo:" | tee-object -append audit.txt
systeminfo | tee-object -append audit.txt
write-output "`n[*] IP Configuration:" | tee-object -append audit.txt
ipconfig | tee-object -append audit.txt
write-output "`n[*] User Privs:" | tee-object -append audit.txt
whoami /all | tee-object -append audit.txt
write-output "`n[*] Arp:" | tee-object -append audit.txt
arp -a | tee-object -append audit.txt
write-output "`n[*] Netstat:" | tee-object -append audit.txt
netstat -ano | tee-object -append audit.txt
write-output "`n[*] Hosts File:" | tee-object -append audit.txt
get-content $env:windir\System32\drivers\etc\hosts | tee-object -append audit.txt
write-output "`n[*] Processes:" | tee-object -append audit.txt
Get-WmiObject win32_process | Select-Object Name,ProcessID,@{n='Owner';e={$_.GetOwner().User}},CommandLine | sort name | format-table -wrap -autosize | tee-object -append audit.txt
write-output "`n[*] Scheduled Tasks:" | tee-object -append audit.txt
schtasks /query /FO CSV /v | convertfrom-csv | where { $_.TaskName -ne "TaskName" } | select "TaskName","Run As User", "Task to Run"  | fl | tee-object -append audit.txt
write-output "`n[*] Services:" | tee-object -append audit.txt
...
write-output "`n[*] Mapped Drives:" | tee-object -append audit.txt
Get-WmiObject -Class Win32_LogicalDisk | select DeviceID, VolumeName | ft -hidetableheaders -autosize | tee-object -append audit.txt
write-output "`n[*] Unquoted Service Paths" | tee-object -append audit.txt
cmd /c  'wmic service get name,displayname,pathname,startmode |findstr /i "auto" |findstr /i /v "c:\windows\\" |findstr /i /v """' | tee-object -append audit.txt
write-output "`n[*] Recent Files:" | tee-object -append audit.txt
get-childitem "C:\Users\$env:username\AppData\Roaming\Microsoft\Windows\Recent"  -EA SilentlyContinue | select Name | ft -hidetableheaders | tee-object -append audit.txt
write-output "`n[*] Interesting Files:" | tee-object -append audit.txt
get-childitem "C:\Users\" -recurse -Include *.zip,*.rar,*.7z,*.gz,*.conf,*.rdp,*.kdbx,*.crt,*.pem,*.ppk,*.txt,*.xml,*.vnc.*.ini,*.vbs,*.bat,*.ps1,*.cmd -EA SilentlyContinue | %{$_.FullName } | tee-object -append audit.txt
...
$EncodedText = ""

$file = [System.Text.Encoding]::ASCII.GetString([System.Convert]::FromBase64String($EncodedText))
$data = $enc.GetBytes($file)|%{$_-bXor0x11}
Write-output "`n[*] Scanning For Common Vulns with Sherlock`n" | tee-object -append audit.txt
iex ([System.Text.Encoding]::ASCII.GetString($data)) | tee-object -append audit.txt
...
Write-Host "Hardening Microsoft Windows 10 compliance script" -ForegroundColor Green
...
$workingdirok = "y"
    ...
    {
    $filepath = "$working\compiance-results.csv"
    }
    else
    {
